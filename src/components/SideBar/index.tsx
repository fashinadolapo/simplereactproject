...
const SideBar = () => {
    ...
    return (
        <Flex  background={'white'} flexDirection={{base: 'row', sm: 'row', md: 'row', lg: 'column'}} position={{base:'fixed', sm: 'fixed', md: 'fixed', lg: 'initial' }} bottom={'0'} alignItems={{base: 'center', sm: 'center', md: 'center', lg: 'center'}} justifyContent={{base: 'space-around', sm: 'space-around', md:'space-around', lg: 'normal'}} height={{base: '87px', sm:'87px', md: '87px', lg: '100%'}}  width={{base:'100%', sm: '100%', md: '100%', lg: '87px'}}>
