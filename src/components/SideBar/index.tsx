...
const SideBar = () => {
    ...
    return (
        <Flex flexDirection={{base: 'row', sm: 'row', md: 'row', lg: 'column'}} alignItems={{base: 'center', sm: 'center', md: 'center', lg: 'center'}} justifyContent={{base: 'space-around', sm: 'space-around', md:'space-around', lg: 'normal'}} height={{ md: '87px', lg: '100%'}}  width={{ md: '100%', lg: '87px'}}>
